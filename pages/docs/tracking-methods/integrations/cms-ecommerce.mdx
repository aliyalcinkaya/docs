...
Though Mixpanel does not have an official plugin to support Shopify, there is a [Vendo app by Growth Analytics Marketing](https://mixpanel.com/partners/integrations/vendo) available in the Shopify app store that will automatically send data from your Shopify store to your Mixpanel implementation. While this integration app is not officially supported by Mixpanel, [it might be worth checking out Vendo's Shopify app if you're looking for a no-code](https://apps.shopify.com/vendo?utm_source=mixpanel&utm_medium=partner).
